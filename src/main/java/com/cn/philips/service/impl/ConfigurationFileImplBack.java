 ...
 * 
 */
public final class ConfigurationFileImplBack {
	/**
	 * 从ini配置文档中读取变量的值
	 * 
	 * @param file
...
//		try {
//
//			System.out.println("值已经改变!... " + ConfigurationFile.setProfileString("E:/web5/h2_test/gamewww.ini",
//					"TestSect1", "10012", "111111"));
//
//			System.out.println("值读取成功!... "
//					+ ConfigurationFile.getProfileString("E:/web5/h2_test/gamewww.ini", "TestSect1", "10012", ""));
//
//		} catch (IOException e) {
