...
public class Rules {
    ...
    private Integer colorconditiona;

    private Integer colorconditionb;
    ...
    public Integer getColorconditiona() {
        return colorconditiona;
    }

    public void setColorconditiona(Integer colorconditiona) {
        this.colorconditiona = colorconditiona;
    }

    public Integer getColorconditionb() {
        return colorconditionb;
    }

    public void setColorconditionb(Integer colorconditionb) {
